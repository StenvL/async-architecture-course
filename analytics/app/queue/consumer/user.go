...
import (
	...
	"github.com/StenvL/async-architecture-course/analytics/app/model"
...
func (c Client) userCreatedConsumer() {
	...
	go c.consume("analytics.users.created", "analytics/users.created", handler)
}
...
func (c Client) userUpdatedConsumer() {
	...
	go c.consume("analytics.users.updated", "analytics/users.updated", handler)
}
func (c Client) userDeletedConsumer() {
	...
	go c.consume("analytics.users.deleted", "analytics/users.deleted", handler)
}
...
func (c Client) userRoleChangedConsumer() {
	...
	go c.consume("analytics.users.role_changed", "analytics/users.role_changed", handler)
}
